...
**Update**: It appears that in recent years (at least in 2017), the
ASOS data is presented at regular 5 minute intervals. So the
strategy below of computing `modalminute` will almost certainly not
work.
